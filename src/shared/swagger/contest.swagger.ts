export const CONTEST_SWAGGER = {
  ...
  getWonContests: {
    ...
    responses: {
      success: {
        status: 200,
        description: 'Won contests retrieved successfully',
      },
    },
  },
  getPostsByContest: {
    ...
    responses: {
      success: {
        status: 200,
        description: 'Contest posts retrieved successfully',
      },
  ...
  getExampleContest: {
    ...
    responses: {
      success: {
        status: 200,
        description: 'Example contest retrieved successfully',
      },
    },
  },
  joinContest: {
    ...
    responses: {
      ...
      badRequest: {
        status: 400,
        description: 'Contest is closed or already joined',
      },
      notFound: { status: 404, description: 'Contest not found' },
    },
  },
