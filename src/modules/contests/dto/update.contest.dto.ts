...
import { SocialPostSettingsDto } from 'src/modules/admin/dto/create-contest.dto';
...
export class UpdateContestDto {
  ...
  @MaxLength(100)
  @ApiPropertyOptional({
    default: `Fine-tune trigger word`,
    type: String,
    nullable: true,
  })
  ...
  @ApiPropertyOptional({
    ...
    type: Number,
    description:
      'Optional media_ai_settings row used by this contest. Fine-tune contests automatically use yengine_portrait.',
  })
