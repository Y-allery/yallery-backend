...
export const RUNPOD_MEDIA_ROUTE_CATALOG: MediaRouteCatalogEntry[] = [
  ...
  },
  {
    ...
    dispatch: MediaDispatch.BULLMQ_QUEUE,
    queueName: MEDIA_PROMPT_IMAGE_GENERATION_QUEUE,
    endpointConfigKey: 'RUNPOD_KREA2_TURBO_ENDPOINT_ID',
    enabledConfigKey: 'RUNPOD_KREA2_TURBO_ENABLED',
    statusTimeoutConfigKey: 'RUNPOD_KREA2_TURBO_STATUS_TIMEOUT_MS',
    statusTimeoutLabel: 'Krea 2 Turbo Status Timeout',
    defaultStatusTimeoutMs: 1200000,
  },
  {
    routeType: 'promptImage',
    ...
    dispatch: MediaDispatch.BULLMQ_QUEUE,
    queueName: MEDIA_PROMPT_IMAGE_GENERATION_QUEUE,
    endpointConfigKey: 'RUNPOD_KREA2_LORA_GENERATION_ENDPOINT_ID',
    enabledConfigKey: 'RUNPOD_KREA2_LORA_GENERATION_ENABLED',
    statusTimeoutConfigKey: 'RUNPOD_KREA2_LORA_GENERATION_STATUS_TIMEOUT_MS',
    statusTimeoutLabel: 'Krea 2 LoRA Generation Status Timeout',
